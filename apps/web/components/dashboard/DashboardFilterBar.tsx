...
function DashboardFilterBarClient() {
    ...
    <div className="mb-6 flex flex-wrap items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
      <div className="flex items-center gap-2">
        ...
        <div className="flex gap-1">
          <FilterButton active={currentRange === '7d'} onClick={() => setRange(7)}>
            7d
          </FilterButton>
          <FilterButton active={currentRange === '30d'} onClick={() => setRange(30)}>
            30d
          </FilterButton>
          <FilterButton active={currentRange === '90d'} onClick={() => setRange(90)}>
            90d
          </FilterButton>
        </div>
      </div>
...
// Wrapper component that only renders on client to avoid SSR issues
export function DashboardFilterBar() {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-2">
            <div className="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-700 rounded-md">
              Cargando...
            </div>
          </div>
        </div>
  ...
  return <DashboardFilterBarClient />;
}
