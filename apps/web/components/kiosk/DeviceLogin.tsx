  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const errorMessage =
          data?.error || data?.message || `Authentication failed (${response.status})`;
    ...
    <div className="max-w-md mx-auto">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Device Login</h2>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          <div className="text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400">Need device credentials?</p>
