    ...
    tests: [
      ...
      },
      {
        ...
        test: async () => {
          ...
          const isLoginPage =
            result.stdout.includes('Iniciar Sesión') &&
            result.stdout.includes('Accede a tu cuenta');
          return {
            success: isLoginPage,
    ...
    tests: [
      ...
      },
      {
        ...
        test: async () => {
          ...
          const hasCookies =
            result.stdout.includes('accessToken') && result.stdout.includes('refreshToken');
          return {
            success: hasCookies,
    ...
    tests: [
      ...
      },
      {
        ...
        test: async () => {
          ...
          const isDashboard =
            result.stdout.includes('Dashboard') && result.stdout.includes('admin@testgym.mx');
          return {
            success: isDashboard,
      ...
      },
      {
        ...
        test: async () => {
          ...
          const isProtectedPage =
            result.stdout.includes('admin@testgym.mx') && !result.stdout.includes('Iniciar Sesión');
          return {
